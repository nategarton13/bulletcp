...
m0cp <- runmcmc_cp0(data = full_data, iter = 5000, start.vals = start.vals, prop_var = prop_var, warmup = 500, verbose = FALSE)
...
m1cp_left <- runmcmc_cp1_left(data = full_data, iter = 5000, warmup = 500, 
...
m1cp_right <- runmcmc_cp1_right(data = full_data, iter = 5000, warmup = 500, 
...
m1cp <- runmcmc_cp1(data = full_data, iter = 5000, 
