...
```{r cp1_gibbs_complicated, echo = TRUE, cache=FALSE}
...
```{r cp1_gibbs_simple, echo = TRUE, cache=FALSE}
...
```{r cp2_gibbs, echo = TRUE, cache=FALSE}
# define starting values
